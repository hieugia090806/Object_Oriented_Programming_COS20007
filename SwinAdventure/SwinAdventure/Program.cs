    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                else if (commandWords.Length > 0 && commandWords[0] == "look")
                {
                ...
                {
                    Console.WriteLine("I don't understand that command. Try 'look at [item]' or 'look at [item] in [container]'. Type 'quit' to exit.");
                }
            }
