...
namespace ShapeDrawing
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            Window window = new Window("ShapeDrawing_Task 5.3C", 800, 600);
            ...
            do
            {
                ...
                //Save the drawing to a file when pressing S key
                if (SplashKit.KeyTyped(KeyCode.SKey))
                {
                    myDrawing.Save("D:\\University\\May_2025\\COS20007_Object_Oriented_Programming\\Weekly_exercises\\5.3C\\TestDrawing.txt");
                }
                //open file
                if (SplashKit.KeyTyped(KeyCode.OKey))
                {
                    try
                    {
                        myDrawing.Load("D:\\University\\May_2025\\COS20007_Object_Oriented_Programming\\Weekly_exercises\\5.3C\\TestDrawing.txt");
                    }
                    catch (Exception e)
                    {
